...
curl --fail --silent --show-error "${WIN_URLC}" --output "$ISODATE-win11-chrome.json";

curl --fail --silent --show-error "${DROID_URLC}" --output "$ISODATE-android-chrome.json";
...
curl --fail --silent --show-error "${LINUX_URLF}" --output "$ISODATE-linux-firefox.json";

curl --fail --silent --show-error "${WIN_URLF}" --output "$ISODATE-win11-firefox.json";

curl --fail --silent --show-error "${DROID_URLF}" --output "$ISODATE-android-firefox.json";
